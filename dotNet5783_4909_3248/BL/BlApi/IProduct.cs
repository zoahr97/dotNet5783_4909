...
{
    public IEnumerable<BO.ProductForList> GetProductsForList();  //1.בקשת רשימת מוצרים
...
//public BO.ProductItem RequestProductDetails2(int productId,BO.Cart c);//3.בקשת פרטי מוצר